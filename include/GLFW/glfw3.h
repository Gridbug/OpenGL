 ...
 *
 *   error An [error code](@ref errors).
 ...
 *   focused `GL_TRUE` if the window was given input focus, or
 ...
 *   iconified `GL_TRUE` if the window was iconified, or `GL_FALSE`
 *  if it was restored.
 *
 ...
 *
 *   window The window that received the event.
 *   entered `GL_TRUE` if the cursor entered the window's client
 ...
 *   event One of `GLFW_CONNECTED` or `GLFW_DISCONNECTED`.
 *
 ...
 *  terminated.
 *
 *   cbfun The new callback, or `NULL` to remove the currently set
 *  callback.
 ...
 *  terminated.
 *
 *   target The [window hint](@ref window_hints) to set.
 ...
 *   monitor The monitor to use for full screen mode, or `NULL` to use
 *  windowed mode.
 ...
 *
 *   window The window to query.
 *   mode One of `GLFW_CURSOR`, `GLFW_STICKY_KEYS` or
 *  `GLFW_STICKY_MOUSE_BUTTONS`.
 *
 *  @par Thread Safety
 *  This function may only be called from the main thread.
 ...
 *
 *   window The window whose callback to set.
 *   cbfun The new key callback, or `NULL` to remove the currently
 *  set callback.
 *  @return The previously set callback, or `NULL` if no callback was set or the
 *  library had not been [initialized](@ref intro_init).
 *
 ...
 *
 *   window The window whose callback to set.
 *   cbfun The new scroll callback, or `NULL` to remove the currently
 *  set callback.
 *  @return The previously set callback, or `NULL` if no callback was set or the
 *  library had not been [initialized](@ref intro_init).
 *
 ...
 *
 *   window The window whose callback to set.
 *   cbfun The new file drop callback, or `NULL` to remove the
 ...
 *
 *   joy The [joystick](@ref joysticks) to query.
